        ...
        <div class="cols-grid">
                <div class="col-content group-chooser">
                    <div class="colspan-m12 choice-gap group-choice"> 
                        <input id="radio-1" name="radioboxgroup" class="hide-choice-input" value="radio-1" type="radio">
                        <label for="radio-1">Title: </label>
                        <span class="mtext-align-center">
                            <span class="choice-value choice-field">Content</span>
                        </span>
                    </div>
                    <div class="colspan-m12 group-choice"> 
                        <input id="radio-2" name="radioboxgroup" class="hide-choice-input" value="radio-2" type="radio">
                        <label for="radio-2">Title: </label>
                        <span class="mtext-align-center">
                            <input placeholder="" size="10" class="choice-value choice-field" type="text">
                        </span>
                    </div>
                </div>
        </div><!--cols-grid-->
